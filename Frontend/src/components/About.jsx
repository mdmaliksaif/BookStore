  ...
  return (
    <div className='text-2xl text-white'>
        ...
        <div className='mt-20 md:flex  '>
            <div><img src="https://cdn.pixabay.com/photo/2015/11/19/21/10/glasses-1052010_640.jpg" className='' alt="" /></div>
            <div className='p-10 -mt-10'>
                <h1 className='text-blue-400'>Our History</h1>
                <div className='w-[800px] '><p className='mr-24'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta animi, accusamus nisi corrupti rem fugit sint necessitatibus aut similique et obcaecati perferendis iure eligendi porro? Nostrum porro commodi similique fugiat!
